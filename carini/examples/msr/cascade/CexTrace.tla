...
VARIABLES currentTerm, log, Fluent4, Fluent3, Fluent2, Fluent1, state, Fluent0, config, cexTraceIdx

vars == <<currentTerm, log, Fluent4, Fluent3, Fluent2, Fluent1, state, Fluent0, config, cexTraceIdx>>
...
CandSep == (\A var0 \in Server : (Fluent3[var0] => Fluent4[var0]))
...
/\ ind > 0
/\ (\A s \in commitQuorum : InLog(<<ind,curTerm>>,s))
