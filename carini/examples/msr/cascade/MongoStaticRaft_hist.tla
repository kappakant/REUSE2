...
VARIABLES committed, currentTerm, log, Fluent4, Fluent3, Fluent2, Fluent1, state, Fluent0, config

vars == <<committed, currentTerm, log, Fluent4, Fluent3, Fluent2, Fluent1, state, Fluent0, config>>

CandSep ==
\A var0 \in FinNat : \E var1 \in Server : \A var2 \in FinNat : (Fluent4[var0][var2]) => (Fluent3[var2][var1])
...
/\ Fluent3' = [Fluent3 EXCEPT ![curTerm][i] = TRUE]
/\ UNCHANGED<<Fluent4>>
...
/\ Fluent3 = [ x0 \in FinNat |-> [ x1 \in Server |-> FALSE]]
