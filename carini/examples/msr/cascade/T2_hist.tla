...
VARIABLES currentTerm, log, Fluent4, Fluent3, Fluent2, Fluent1, state, Fluent0, config

vars == <<currentTerm, log, Fluent4, Fluent3, Fluent2, Fluent1, state, Fluent0, config>>
