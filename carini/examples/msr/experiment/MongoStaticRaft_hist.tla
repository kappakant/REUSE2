...
VARIABLES committed, currentTerm, Fluent8, Fluent7, log, Fluent2, Fluent1, state, Fluent0, config

vars == <<committed, currentTerm, Fluent8, Fluent7, log, Fluent2, Fluent1, state, Fluent0, config>>
