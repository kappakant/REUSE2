...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT15->T2) + (PT22->T3) + (PT4->T2) + (PT21->T3) + (PT17->T3) + (PT31->T3) + (PT2->T2) + (PT35->T3) + (PT38->T3) + (PT23->T3) + (PT34->T3) + (PT29->T3) + (PT18->T3) + (PT3->T2) + (PT36->T3) + (PT1->T9) + (PT37->T2) + (PT25->T3) + (PT26->T3) + (PT30->T3) + (NT1->T9)
	...
	path = (PT15 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n2_NUM2NUM1NUM1 + T2->ClientRequestn1NUM1)) +
		...
		(PT31 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->GetEntriesn2n1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn1NUM1)) +
		(PT2 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
		(PT35 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->GetEntriesn2n1 + T2->CommitEntryn1_n1n2_NUM1NUM1NUM1 + T3->ClientRequestn1NUM1)) +
		(PT38 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n2_NUM1NUM1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn1NUM1)) +
		(PT23 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n2n3_NUM2 + T2->ClientRequestn1NUM1 + T3->CommitEntryn2_n2n3_NUM2NUM2NUM2)) +
		(PT34 -> (T0->GetEntriesn1n1 + T1->BecomeLeadern1_n1n2_NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn1NUM1)) +
		...
		(PT36 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->GetEntriesn2n1 + T3->CommitEntryn1_n1n2_NUM2NUM1NUM1)) +
		...
		(PT37 -> (T0->BecomeLeadern1_n1n2n3_NUM1 + T1->BecomeLeadern1_n1n2_NUM2 + T2->ClientRequestn1NUM2)) +
		...
		(PT30 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n2n3_NUM2 + T2->CommitEntryn2_n2n3_NUM2NUM2NUM2 + T3->ClientRequestn1NUM1)) +
