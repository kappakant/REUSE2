...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT5->T2) + (PT1->T7) + (NT1->T7)

	path = (PT5 -> (T0->GetEntriesn1n1 + T1->BecomeLeadern1_n1n2_NUM1 + T2->ClientRequestn1NUM1)) +
		(PT1 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->BecomeLeadern2_n1n2_NUM2 + T2->ClientRequestn2NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn1n2 + T5->GetEntriesn3n2 + T6->GetEntriesn1n2 + T7->ClientRequestn2NUM2)) +
