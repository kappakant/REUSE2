...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT11->T3) + (PT6->T1) + (PT10->T3) + (PT1->T9) + (NT1->T9)
	...
	path = (PT11 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern1_n1n3_NUM2 + T3->ClientRequestn1NUM2)) +
		...
		(PT10 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern1_n1n2_NUM2 + T3->ClientRequestn1NUM2)) +
