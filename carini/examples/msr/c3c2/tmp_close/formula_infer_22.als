...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT70->T3) + (PT55->T3) + (PT54->T2) + (PT66->T2) + (PT37->T2) + (PT60->T3) + (PT72->T2) + (PT71->T3) + (PT50->T2) + (PT1->T0) + (PT58->T4) + (PT68->T2) + (PT47->T3) + (PT42->T2) + (PT24->T1) + (PT44->T1) + (PT69->T1) + (PT30->T3) + (PT46->T2) + (PT61->T2) + (PT36->T2) + (PT43->T2) + (NT1->T10)
