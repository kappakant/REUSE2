...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT91->T3) + (PT70->T3) + (PT55->T3) + (PT66->T2) + (PT37->T2) + (PT86->T3) + (PT71->T3) + (PT1->T0) + (PT58->T4) + (PT68->T2) + (PT76->T3) + (PT47->T3) + (PT42->T2) + (PT44->T1) + (PT69->T1) + (PT84->T3) + (PT85->T3) + (PT78->T4) + (NT1->T9)
