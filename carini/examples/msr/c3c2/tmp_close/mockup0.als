...
fact {
	...
	//no Root.children.children.left.falsifyFl
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT3->T1) + (PT2->T1) + (PT1->T0) + (NT1->T6)

	path = (PT3 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
		(PT2 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n2_NUM2NUM1NUM1)) +
		(PT1 -> (T0->BecomeLeadern1_n1n3_NUM1)) +
		(NT1 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->ClientRequestn1NUM1 + T2->BecomeLeadern2_n2n3_NUM2 + T3->ClientRequestn2NUM2 + T4->GetEntriesn3n1 +
            T5->BecomeLeadern1_n1n3_NUM3 + T6->CommitEntryn1_n1n3_NUM1NUM1NUM1))
