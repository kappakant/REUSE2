...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT70->T3) + (PT54->T2) + (PT37->T2) + (PT60->T3) + (PT59->T2) + (PT73->T3) + (PT50->T2) + (PT1->T0) + (PT58->T4) + (PT24->T1) + (PT44->T1) + (PT69->T1) + (PT30->T3) + (PT27->T2) + (PT61->T2) + (PT36->T2) + (NT1->T10)
