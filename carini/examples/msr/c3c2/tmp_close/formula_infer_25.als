...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT24->T1) + (PT17->T1) + (PT20->T2) + (PT1->T0) + (NT1->T9)

	path = (PT24 -> (T0->BecomeLeadern1_n1n2n3_NUM1 + T1->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
		(PT17 -> (T0->BecomeLeadern1_n1n2_NUM1 + T1->CommitEntryn1_n1n2_NUM1NUM1NUM1)) +
