...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (NT1->T8) + (PT45->T7) + (PT47->T3) + (PT46->T2)

	path = (NT1 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->RcvCommitr1 + T7->SndAbortr1 + T8->RcvAbortr2)) +
		(PT45 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->SndCommitr2 + T7->RcvCommitr1)) +
		(PT47 -> (T0->SndPreparer1 + T1->SndAbortr1 + T2->RcvPreparer1 + T3->RcvAbortr2)) +
		(PT46 -> (T0->SndAbortr1 + T1->SndPreparer1 + T2->RcvAbortr1))
