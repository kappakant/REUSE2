...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT13->T6) + (PT11->T7) + (PT16->T3) + (NT1->T9) + (PT14->T7) + (PT12->T2) + (PT15->T2)

	path = (PT13 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->SndPreparer3 + T4->RcvPreparer3 + T5->RcvPreparer2 + T6->SndCommitr1)) +
		(PT11 -> (T0->SndPreparer2 + T1->SndPreparer1 + T2->RcvPreparer1 + T3->SndPreparer3 + T4->RcvPreparer3 + T5->RcvPreparer2 + T6->SndAbortr1 + T7->RcvAbortr1)) +
		(PT16 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndAbortr2 + T3->RcvAbortr1)) +
		(NT1 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndCommitr1 + T3->SndPreparer2 + T4->RcvPreparer2 + T5->SndAbortr2 + T6->RcvAbortr2 + T7->SndPreparer3 + T8->RcvPreparer3 + T9->RcvCommitr1)) +
		(PT14 -> (T0->SndPreparer1 + T1->SndPreparer2 + T2->RcvPreparer1 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->SndCommitr1 + T7->RcvCommitr1)) +
		(PT12 -> (T0->SndAbortr1 + T1->SndAbortr2 + T2->RcvAbortr3)) +
		(PT15 -> (T0->SndAbortr1 + T1->SndPreparer1 + T2->RcvAbortr1))
