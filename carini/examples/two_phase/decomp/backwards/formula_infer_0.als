...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT21->T3) + (PT22->T2) + (PT16->T2) + (PT20->T2) + (PT15->T2) + (PT19->T1) + (PT18->T2) + (NT1->T8) + (PT14->T3) + (PT17->T2)

	path = (PT21 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->SndPreparer3)) +
		(PT22 -> (T0->SndPreparer1 + T1->SndAbortr1 + T2->RcvAbortr1)) +
		(PT16 -> (T0->SndPreparer1 + T1->SndPreparer2 + T2->SndPreparer3)) +
		(PT20 -> (T0->SndAbortr1 + T1->RcvAbortr1 + T2->RcvPreparer1)) +
		(PT15 -> (T0->RcvPreparer1 + T1->SndPreparer1 + T2->SndCommitr1)) +
		(PT19 -> (T0->SndAbortr1 + T1->RcvAbortr2)) +
		(PT18 -> (T0->SndAbortr1 + T1->RcvAbortr1 + T2->SndCommitr1)) +
		(NT1 -> (T0->SndPreparer1 + T1->RcvAbortr1 + T2->RcvPreparer1 + T3->SndPreparer2 + T4->RcvPreparer2 + T5->SndPreparer3 + T6->RcvPreparer3 + T7->SndCommitr1 + T8->RcvCommitr2)) +
		(PT14 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->RcvPreparer2 + T3->RcvPreparer3)) +
		(PT17 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->RcvCommitr1))
