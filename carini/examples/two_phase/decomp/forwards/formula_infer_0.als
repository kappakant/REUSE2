...
one sig SndCommitr2 extends Act {} {
	params = (P0->r2)
}
...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT13->T7) + (PT17->T2) + (PT11->T7) + (PT14->T1) + (PT15->T7) + (PT12->T7) + (NT1->T10) + (PT16->T1)

	path = (PT13 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->SndCommitr1 + T7->RcvCommitr2)) +
		(PT17 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndAbortr1)) +
		(PT11 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->SndCommitr1 + T7->RcvCommitr1)) +
		(PT14 -> (T0->SndAbortr1 + T1->SndPreparer1)) +
		(PT15 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->RcvAbortr1 + T4->SndPreparer3 + T5->RcvPreparer2 + T6->RcvPreparer3 + T7->SndCommitr1)) +
		(PT12 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndPreparer2 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->SndCommitr1 + T7->RcvAbortr1)) +
		(NT1 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndAbortr1 + T3->SndPreparer1 + T4->SndPreparer2 + T5->RcvPreparer2 + T6->RcvAbortr1 + T7->SndPreparer3 + T8->SndCommitr2 + T9->RcvPreparer3 + T10->RcvCommitr2)) +
		(PT16 -> (T0->SndAbortr1 + T1->RcvAbortr1))
	...
	baseName = RcvAbortr1->RcvAbort +
		SndCommitr2->SndCommit +
		SndAbortr1->SndAbort +
