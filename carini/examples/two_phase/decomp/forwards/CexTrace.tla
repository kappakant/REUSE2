...
VARIABLES msgs, tmState, tmPrepared, rmState, Fluent27, Fluent26, cexTraceIdx

vars == <<msgs, tmState, tmPrepared, rmState, Fluent27, Fluent26, cexTraceIdx>>
...
/\ cexTraceIdx = 2 =>
  /\ msgs = {[type |-> "Prepared", theRM |-> r1]}
  /\ rmState = (r1 :> "prepared" @@ r2 :> "working" @@ r3 :> "working")
  /\ Fluent26 = (r1 :> TRUE @@ r2 :> FALSE @@ r3 :> FALSE)
  /\ Fluent27 = (r1 :> TRUE @@ r2 :> FALSE @@ r3 :> FALSE)
  /\ tmState = "init"
  /\ tmPrepared = {r1}
...
CandSep == (\A var0 \in RMs : (Fluent26[var0] => Fluent27[var0]))
...
/\ tmState' = "aborted"
/\ UNCHANGED <<tmPrepared,rmState>>
/\ Fluent27' = [Fluent27 EXCEPT![rm] = FALSE]
/\ UNCHANGED <<Fluent26>>
/\ cexTraceIdx' = cexTraceIdx + 1
/\ TraceConstraint'
