...
fact PartialInstance {
	lastIdx = (EmptyTrace->T0) + (PT1->T0) + (PT2->T7) + (PT3->T1) + (PT4->T3) + (PT5->T0) + (NT1->T0)

	path = (PT1 -> (T0->SndAbortr1)) +
		(PT2 -> (T0->SndPreparer2 + T1->SndPreparer1 + T2->RcvPreparer1 + T3->RcvPreparer2 + T4->SndPreparer3 + T5->RcvPreparer3 + T6->SndCommitr1 + T7->RcvCommitr1)) +
		(PT3 -> (T0->SndAbortr1 + T1->RcvAbortr1)) +
		(PT4 -> (T0->SndPreparer1 + T1->RcvPreparer1 + T2->SndAbortr1 + T3->RcvAbortr2)) +
		(PT5 -> (T0->SilentAbortr1)) +
		(NT1 -> (T0->SilentAbortr1))
