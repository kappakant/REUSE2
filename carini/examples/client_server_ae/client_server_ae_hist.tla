--------------------------- MODULE client_server_ae_hist ---------------------------


CONSTANTS Node, Request, Response

VARIABLES onceRespond, request_sent, response_sent, match, onceNewRequest, response_received, onceReceiveResponse

vars == <<onceRespond, request_sent, response_sent, match, onceNewRequest, response_received, onceReceiveResponse>>
