---- MODULE CexTrace_TTrace_1749661863 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661863.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661863.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "prepared" @@ res2 :> "abort" @@ res3 :> "working"),cexTraceIdx |-> 3]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),err |-> TRUE,rmState |-> (res1 :> "prepared" @@ res2 :> "abort" @@ res3 :> "commit"),cexTraceIdx |-> 4])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749661863 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
