---- MODULE CexTrace_TTrace_1749661947 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent16_0 = ((res1 :> FALSE @@ res2 :> FALSE @@ res3 :> TRUE))
        /\
        err = (TRUE)
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661947.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661947.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent16_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "working" @@ res2 :> "working" @@ res3 :> "working"),cexTraceIdx |-> 0]),
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent16_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "prepared" @@ res2 :> "working" @@ res3 :> "working"),cexTraceIdx |-> 1]),
    ([Fluent17_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent16_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "abort" @@ res2 :> "working" @@ res3 :> "working"),cexTraceIdx |-> 2]),
    ([Fluent17_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent16_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "working"),cexTraceIdx |-> 3]),
    ([Fluent17_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent16_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> TRUE),err |-> TRUE,rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "commit"),cexTraceIdx |-> 4])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749661947 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:12:28 EDT 2025