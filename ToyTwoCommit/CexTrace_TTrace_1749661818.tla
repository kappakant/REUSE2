---- MODULE CexTrace_TTrace_1749661818 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661818.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661818.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([tmState |-> "init",err |-> TRUE,tmPrepared |-> {res2},cexTraceIdx |-> 1])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749661818 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:18 EDT 2025