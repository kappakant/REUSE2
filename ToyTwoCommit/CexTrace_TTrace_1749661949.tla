---- MODULE CexTrace_TTrace_1749661949 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent8_0 = ((res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661949.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661949.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([err |-> FALSE,Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "prepared" @@ res3 :> "prepared"),cexTraceIdx |-> 3]),
    ([err |-> FALSE,Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "commit" @@ res3 :> "prepared"),cexTraceIdx |-> 4]),
    ([err |-> FALSE,Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "commit" @@ res2 :> "commit" @@ res3 :> "prepared"),cexTraceIdx |-> 5]),
    ([err |-> TRUE,Fluent9_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "commit" @@ res3 :> "prepared"),cexTraceIdx |-> 6])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749661949 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
