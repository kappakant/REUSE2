---- MODULE ToyRM_hist_TTrace_1749661857 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent5_0 = ((res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyRM_hist_TTrace_1749661857.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyRM_hist_TTrace_1749661857.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([Fluent6_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "working" @@ res2 :> "working" @@ res3 :> "working")]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "working" @@ res3 :> "working")]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "prepared" @@ res3 :> "working")]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent9_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "abort" @@ res3 :> "working")]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent9_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "abort" @@ res3 :> "commit")])
    >>
----
...
---- CONFIG ToyRM_hist_TTrace_1749661857 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res3 = res3
    res1 = res1
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:57 EDT 2025