---- MODULE CexTrace_TTrace_1749663877 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent17_0 = ((res1 :> FALSE @@ res2 :> FALSE @@ res3 :> TRUE))
        /\
        err = (TRUE)
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663877.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663877.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> TRUE),err |-> TRUE,Fluent18_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "commit"),cexTraceIdx |-> 4])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663877 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
