---- MODULE ToyTM_hist_TTrace_1749661845 ----
...
_inv ==
    ~(
        ...
        tmState = ("init")
        /\
        Fluent8_0 = ((res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE))
        /\
        tmPrepared = ({res1, res2})
        /\
        Fluent7_0 = ((res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE))
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749661845.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749661845.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([tmState |-> "init",Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmPrepared |-> {},Fluent7_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",Fluent8_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),tmPrepared |-> {res1},Fluent7_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",Fluent8_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),tmPrepared |-> {res1, res2},Fluent7_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE)])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749661845 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:45 EDT 2025