---- MODULE CexTrace_TTrace_1749661836 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661836.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661836.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),err |-> TRUE,rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "commit"),cexTraceIdx |-> 4])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749661836 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:36 EDT 2025