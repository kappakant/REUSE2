---- MODULE ToyTM_hist_TTrace_1749663716 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent1_0 = ((res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE))
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749663716.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749663716.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([tmState |-> "init",tmPrepared |-> {},Fluent1_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res1},Fluent1_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res1, res2},Fluent1_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res1, res2, res3},Fluent1_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "commit",tmPrepared |-> {res1, res2, res3},Fluent1_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE)])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749663716 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:41:56 EDT 2025