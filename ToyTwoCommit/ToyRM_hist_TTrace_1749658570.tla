---- MODULE ToyRM_hist_TTrace_1749658570 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyRM_hist_TTrace_1749658570.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyRM_hist_TTrace_1749658570.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([rmState |-> (res1 :> "commit" @@ res2 :> "working" @@ res3 :> "working")]),
    ([rmState |-> (res1 :> "commit" @@ res2 :> "prepared" @@ res3 :> "working")]),
    ([rmState |-> (res1 :> "commit" @@ res2 :> "abort" @@ res3 :> "working")])
    >>
----
...
---- CONFIG ToyRM_hist_TTrace_1749658570 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res3 = res3
    res1 = res1
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 12:16:11 EDT 2025