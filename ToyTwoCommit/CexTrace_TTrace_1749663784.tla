---- MODULE CexTrace_TTrace_1749663784 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663784.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663784.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([err |-> FALSE,Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "prepared" @@ res3 :> "working"),Fluent10_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 2]),
    ([err |-> FALSE,Fluent9_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "working"),Fluent10_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 3]),
    ([err |-> TRUE,Fluent9_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "commit"),Fluent10_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 4])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663784 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
