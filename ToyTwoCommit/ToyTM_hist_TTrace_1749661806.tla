---- MODULE ToyTM_hist_TTrace_1749661806 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749661806.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749661806.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ToyTM_hist_TTrace_1749661806 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res2 = res2
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:06 EDT 2025