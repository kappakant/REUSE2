---- MODULE CexTrace_TTrace_1749663778 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663778.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663778.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent6_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,Fluent7_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> TRUE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "prepared"),cexTraceIdx |-> 4]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> TRUE),err |-> TRUE,Fluent7_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> TRUE),rmState |-> (res1 :> "abort" @@ res2 :> "commit" @@ res3 :> "prepared"),cexTraceIdx |-> 5])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663778 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
