---- MODULE CexTrace_TTrace_1749663845 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663845.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663845.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CexTrace_TTrace_1749663845 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:44:05 EDT 2025