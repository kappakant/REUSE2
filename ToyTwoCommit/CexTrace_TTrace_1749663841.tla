---- MODULE CexTrace_TTrace_1749663841 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663841.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663841.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([tmState |-> "abort",err |-> TRUE,tmPrepared |-> {},cexTraceIdx |-> 1])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663841 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:44:02 EDT 2025