---- MODULE ToyTM_hist_TTrace_1749663768 ----
...
_inv ==
    ~(
        ...
        tmState = ("init")
        /\
        Fluent9_0 = ((res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749663768.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749663768.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([tmState |-> "init",Fluent9_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmPrepared |-> {}]),
    ([tmState |-> "init",Fluent9_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),tmPrepared |-> {res2}]),
    ([tmState |-> "init",Fluent9_0 |-> (res1 :> TRUE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent8_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),tmPrepared |-> {res1, res2}])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749663768 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res3 = res3
    res2 = res2
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:42:48 EDT 2025