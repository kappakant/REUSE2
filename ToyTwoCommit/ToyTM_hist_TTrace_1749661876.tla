---- MODULE ToyTM_hist_TTrace_1749661876 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749661876.json", _TETrace)
...
expression == 
    [
        ...
        \* ,_Fluent10_0Unchanged |-> Fluent10_0 = Fluent10_0'
        
        \* Format the `Fluent10_0` variable as Json value.
        \* ,_Fluent10_0Json |->
        \*     LET J == INSTANCE Json
        \*     IN J!ToJson(Fluent10_0)
        ...
        \*         IF s = 1 THEN 0
        \*         ELSE IF _TETrace[s].Fluent10_0 # _TETrace[s-1].Fluent10_0
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749661876.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([tmState |-> "init",tmPrepared |-> {},Fluent10_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res2},Fluent10_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res2, res3},Fluent10_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res1, res2, res3},Fluent10_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "commit",tmPrepared |-> {res1, res2, res3},Fluent10_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE)])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749661876 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:11:16 EDT 2025