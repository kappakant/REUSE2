---- MODULE CexTrace_TTrace_1749663777 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663777.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663777.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([err |-> FALSE,Fluent9_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "working" @@ res3 :> "working"),Fluent10_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 2]),
    ([err |-> TRUE,Fluent9_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "commit" @@ res3 :> "working"),Fluent10_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 3])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663777 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:42:57 EDT 2025