---- MODULE CexTrace_TTrace_1749663842 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663842.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663842.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent14_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "abort" @@ res2 :> "working" @@ res3 :> "working"),cexTraceIdx |-> 1]),
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> TRUE),Fluent14_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "commit" @@ res2 :> "working" @@ res3 :> "working"),cexTraceIdx |-> 2]),
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> TRUE),Fluent14_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> TRUE,rmState |-> (res1 :> "commit" @@ res2 :> "abort" @@ res3 :> "working"),cexTraceIdx |-> 3])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663842 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:44:03 EDT 2025