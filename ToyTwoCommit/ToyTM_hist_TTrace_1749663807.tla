---- MODULE ToyTM_hist_TTrace_1749663807 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749663807.json", _TETrace)
...
expression == 
    [
        ...
        \* ,_Fluent12_0Unchanged |-> Fluent12_0 = Fluent12_0'
        
        \* Format the `Fluent12_0` variable as Json value.
        \* ,_Fluent12_0Json |->
        \*     LET J == INSTANCE Json
        \*     IN J!ToJson(Fluent12_0)
        ...
        \*         IF s = 1 THEN 0
        \*         ELSE IF _TETrace[s].Fluent12_0 # _TETrace[s-1].Fluent12_0
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749663807.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([tmState |-> "init",tmPrepared |-> {},Fluent13_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent12_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "init",tmPrepared |-> {res1},Fluent13_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent12_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([tmState |-> "abort",tmPrepared |-> {res1},Fluent13_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent12_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE)])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749663807 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:43:27 EDT 2025