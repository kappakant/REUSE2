---- MODULE CexTrace_TTrace_1749663756 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663756.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663756.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent3_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,rmState |-> (res1 :> "commit" @@ res2 :> "working" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 2]),
    ([Fluent3_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> TRUE,rmState |-> (res1 :> "commit" @@ res2 :> "abort" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),cexTraceIdx |-> 3])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663756 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:42:36 EDT 2025