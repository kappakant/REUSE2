---- MODULE ToyTM_hist_TTrace_1749663739 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent6_0 = ((res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE))
        /\
        Fluent5_0 = ((res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE))
        /\
        tmState = ("commit")
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749663739.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749663739.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([Fluent6_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "init",tmPrepared |-> {}]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "init",tmPrepared |-> {res1}]),
    ([Fluent6_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "init",tmPrepared |-> {res1, res2}]),
    ([Fluent6_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> TRUE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "init",tmPrepared |-> {res1, res2, res3}]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "init",tmPrepared |-> {res1, res2, res3}]),
    ([Fluent6_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent5_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "commit",tmPrepared |-> {res1, res2, res3}])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749663739 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res3 = res3
    res1 = res1
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:42:20 EDT 2025