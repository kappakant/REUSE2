---- MODULE CexTrace_TTrace_1749663876 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent17_0 = ((res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE))
        /\
        err = (TRUE)
        /\
        Fluent18_0 = ((res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663876.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663876.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,Fluent18_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "working" @@ res3 :> "working"),cexTraceIdx |-> 2]),
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,Fluent18_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "working"),cexTraceIdx |-> 3]),
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),err |-> FALSE,Fluent18_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "prepared"),cexTraceIdx |-> 4]),
    ([Fluent17_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),err |-> TRUE,Fluent18_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "commit" @@ res3 :> "prepared"),cexTraceIdx |-> 5])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663876 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:44:37 EDT 2025