---- MODULE ToyRM_hist_TTrace_1749663708 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyRM_hist_TTrace_1749663708.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyRM_hist_TTrace_1749663708.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ToyRM_hist_TTrace_1749663708 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res2 = res2
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:41:48 EDT 2025