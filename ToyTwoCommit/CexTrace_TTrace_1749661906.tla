---- MODULE CexTrace_TTrace_1749661906 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661906.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661906.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CexTrace_TTrace_1749661906 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:11:46 EDT 2025