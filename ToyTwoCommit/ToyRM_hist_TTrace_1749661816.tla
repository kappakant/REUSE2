---- MODULE ToyRM_hist_TTrace_1749661816 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyRM_hist_TTrace_1749661816.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyRM_hist_TTrace_1749661816.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([Fluent3_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "working" @@ res2 :> "working" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([Fluent3_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "working" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([Fluent3_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "prepared" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE)]),
    ([Fluent3_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE),rmState |-> (res1 :> "abort" @@ res2 :> "commit" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> FALSE)])
    >>
----
...
---- CONFIG ToyRM_hist_TTrace_1749661816 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res2 = res2
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:16 EDT 2025