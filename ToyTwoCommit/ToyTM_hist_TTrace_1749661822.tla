---- MODULE ToyTM_hist_TTrace_1749661822 ----
...
_inv ==
    ~(
        ...
        tmState = ("commit")
        /\
        Fluent4_0 = ((res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyTM_hist_TTrace_1749661822.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyTM_hist_TTrace_1749661822.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Fluent5_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "init",Fluent4_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmPrepared |-> {res2}]),
    ...
    ([Fluent5_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),tmState |-> "commit",Fluent4_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),tmPrepared |-> {res1, res2, res3}])
    >>
----
...
---- CONFIG ToyTM_hist_TTrace_1749661822 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res2 = res2
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:10:22 EDT 2025