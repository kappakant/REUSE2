---- MODULE ToyRM_hist_TTrace_1749663843 ----
...
_inv ==
    ~(
        ...
        /\
        Fluent15_0 = ((res1 :> FALSE @@ res2 :> TRUE @@ res3 :> TRUE))
        /\
        Fluent14_0 = ((res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ToyRM_hist_TTrace_1749663843.json", _TETrace)
...
\*
\*trace == IODeserialize("ToyRM_hist_TTrace_1749663843.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent14_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent3_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "working" @@ res2 :> "working" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent14_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent3_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "prepared" @@ res2 :> "working" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> TRUE),Fluent14_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent3_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "commit" @@ res2 :> "working" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE)]),
    ([Fluent15_0 |-> (res1 :> FALSE @@ res2 :> TRUE @@ res3 :> TRUE),Fluent14_0 |-> (res1 :> FALSE @@ res2 :> FALSE @@ res3 :> FALSE),Fluent3_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE),rmState |-> (res1 :> "commit" @@ res2 :> "abort" @@ res3 :> "working"),Fluent2_0 |-> (res1 :> TRUE @@ res2 :> FALSE @@ res3 :> FALSE)])
    >>
----
...
---- CONFIG ToyRM_hist_TTrace_1749663843 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:44:04 EDT 2025