---- MODULE CexTrace_TTrace_1749663851 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749663851.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749663851.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([tmState |-> "init",err |-> FALSE,tmPrepared |-> {res1},cexTraceIdx |-> 1]),
    ([tmState |-> "init",err |-> FALSE,tmPrepared |-> {res1, res2},cexTraceIdx |-> 2]),
    ([tmState |-> "init",err |-> FALSE,tmPrepared |-> {res1, res2, res3},cexTraceIdx |-> 3]),
    ([tmState |-> "commit",err |-> FALSE,tmPrepared |-> {res1, res2, res3},cexTraceIdx |-> 4]),
    ([tmState |-> "commit",err |-> TRUE,tmPrepared |-> {res1, res2, res3},cexTraceIdx |-> 5])
    >>
----
...
---- CONFIG CexTrace_TTrace_1749663851 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jun 11 13:44:11 EDT 2025