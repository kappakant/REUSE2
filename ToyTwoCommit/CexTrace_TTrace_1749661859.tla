---- MODULE CexTrace_TTrace_1749661859 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CexTrace_TTrace_1749661859.json", _TETrace)
...
\*
\*trace == IODeserialize("CexTrace_TTrace_1749661859.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG CexTrace_TTrace_1749661859 ----
CONSTANTS
    RMs = { res1 , res2 , res3 }
    res1 = res1
    res3 = res3
